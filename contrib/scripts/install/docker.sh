...
echo -n "* Removing existing DOCUMIUM EDMS and PostgreSQL containers (no data will be lost)..."
...
echo -n "* Pulling (downloading) the DOCUMIUM EDMS Docker image..."
...
echo -n "* Deploying DOCUMIUM EDMS container..."
docker run -d \
...
echo -n "* Waiting for the DOCUMIUM EDMS container to be ready (might take a few minutes)..."
